    ...
    constructor(scope: Construct, id: string, props: ApiStackProps) {
        ...
        this.webSocketApi = new WebSocketApi(this, 'WebRtcWebSocketApi', {
            ...
            disconnectRouteOptions: {
                integration: new WebSocketLambdaIntegration('WebRtcDisconnectIntegration', handler),
            },
            defaultRouteOptions: {
                integration: new WebSocketLambdaIntegration('WebRtcDefaultIntegration', handler),
            },
